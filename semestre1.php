                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right">
                      <li>
                        <a href="semestre.php" class="btn btn-success">Agregar Nuevo</a>
                      </li>
                    </ul>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="operaciones/eliminar_semestre.php?id=<?php echo $res_b_semestre['id']; ?>" class="btn btn-danger">Eliminar</a>
                          </td>
                        </tr>
                        <?php
                        }
