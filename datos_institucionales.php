                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                        $b_datos_institucionales = buscarDatosInstitucionales($conexion);
                        ...
                        <tr>
                          ...
                          <td><?php echo $res_b_datos_institucionales['telefono']; ?></td>
                          <td><?php echo $res_b_datos_institucionales['correo']; ?></td>
                          <td><?php echo $res_b_datos_institucionales['nro_resolucion']; ?></td>
                          <td>
                            <a href="editar_datos_institucionales.php?id=<?php echo $res_b_datos_institucionales['ruc']; ?>" class="btn btn-primary">Editar</a>
                          </td>
                        </tr>
                        <?php
                        }
