                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                        $b_usuario_estudiante = buscarUsuarioEstudiante($conexion);
                        while ($res_b_usuario_estudiante = mysqli_fetch_array($b_usuario_estudiante)) {
                        ?>
                        <tr>
                          <td><?php echo $res_b_usuario_estudiante['id']; ?></td>
