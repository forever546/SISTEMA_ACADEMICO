                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right">
                      <li>
                        <a href="modulo_formativo.php" class="btn btn-success">Agregar Nuevo</a>
                      </li>
                    </ul>
                  ...
                  <div class="x_content">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                        $b_modulo_formativo = buscarModuloFormativo($conexion);
                        while ($res_b_modulo_formativo = mysqli_fetch_array($b_modulo_formativo)) {
                        ?>
                        <tr>
                          <td><?php echo $res_b_modulo_formativo['id']; ?></td>
                          <td><?php echo $res_b_modulo_formativo['descripcion']; ?></td>
                          <td><?php echo $res_b_modulo_formativo['nro_modulo']; ?></td>
